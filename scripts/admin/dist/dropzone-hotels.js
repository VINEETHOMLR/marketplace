...
// url does not has to be written if we have wrote action in the form tag but i have mentioned here just for convenience sake 
   ...
   // z-index: 21;
        ...
        $.ajax({
        type: 'POST',
        url: base+'hotels/hotels/remove_image',
         ...
         //   $('#dropzonePreview').empty();
          ...
          init: function() {
             ...
             var hotel_id=$('#hotel_id').val();
              $.ajax({
              url: base+'hotels/hotels/get_images',
              type: "post",
              dataType:'json',
              ...
              success: function (data) {
                ...
                accepted: true ,url:base+"assets/uploads/hotel/"+value.name};
                 
                 
                myDropzone.options.addedfile.call(myDropzone, mockFile);
 
                myDropzone.options.thumbnail.call(myDropzone, mockFile, base+"assets/uploads/hotel/"+value.name);
