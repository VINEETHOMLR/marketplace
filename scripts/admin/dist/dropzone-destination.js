...
// url does not has to be written if we have wrote action in the form tag but i have mentioned here just for convenience sake 
   ...
   // z-index: 21;
        ...
        $.ajax({
        type: 'POST',
        url: base+'destination/destinations/remove_image',
         ...
         //   $('#dropzonePreview').empty();
          ...
          init: function() {
             ...
             var destination_id=$('#destination_id').val();
              $.ajax({
              url: base+'destination/destinations/get_images',
              type: "post",
              dataType:'json',
              ...
              success: function (data) {
                ...
                accepted: true ,url:base+"assets/uploads/destination/"+value.name};
                 
                 
                myDropzone.options.addedfile.call(myDropzone, mockFile);
 
                myDropzone.options.thumbnail.call(myDropzone, mockFile, base+"assets/uploads/destination/"+value.name);
