...
// url does not has to be written if we have wrote action in the form tag but i have mentioned here just for convenience sake 
   ...
   // z-index: 21;
        ...
        $.ajax({
        type: 'POST',
        url: base_url+'clients/remove_image',
          ...
          init: function() {
             ...
             var myDropzone = this;
              ...
              success: function (data) {
                ...
                var mockFile = { name: value.name, size: value.size,id:value.client_id,status: Dropzone.ADDED,
                accepted: true ,url:base+"assets/uploads/adds/"+value.name};
                 
                 
                myDropzone.options.addedfile.call(myDropzone, mockFile);
 
                myDropzone.options.thumbnail.call(myDropzone, mockFile, base+"assets/uploads/clients/"+value.name);
