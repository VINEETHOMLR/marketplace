...
class Ion_auth_model extends CI_Model
{
	...
	public function change_password_employee($identity,$email,$new)
	{

            $hashed_new_password  = $this->hash_password($new, NULL);
			$data = array(
			    'password' => $hashed_new_password,
			    'remember_code' => NULL,
			);
        
        $successfully_changed_password_in_db = $this->db->update($this->tables['users'], $data, array($identity => $email));
