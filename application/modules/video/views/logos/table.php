...
<div id="add-new-modal" class="modal fade" role="dialog">
  <div class="modal-dialog"  id="add-new-template">
    <form class="" method="post" action="<?=$this->base?>gallery/admin_gallery/update">
		...
		},
		{
			...
			formatter : function(value , row){
				var xEditableOptions	=	{
						...
						pk: row.gallery_id,
						name : 'gallery_status',
						url: "<?=$this->base?>gallery/admin_gallery/change_status",
						title: "Change Status",
...
var actions = {
	delete : {
		url : base + "gallery/admin_gallery/remove/",
	},
	add : {
		selector : '#add_new',
		template : '#add-new-template',
		modal : '#add-new-modal',
		url : base + 'gallery/admin_gallery/form/'
		
	},
	edit : {
		url : base + "gallery/admin_gallery/update/",
		modal : '#add-new-modal',
		url : base +  'gallery/admin_gallery/form/'
	}
};
