<?php
class Admin_astrologer_pending extends MX_Controller {
		...
		{
			$data[ 'content' ] = 'astrologer/table/pending';
		...
		public function list_json()
		{
			...
			foreach( $rows as $v )
			{
				...
				$v[ 'astrologer_proofs' ]=	Modules::run( 'admin/admin_astrologer/proofs' , $astrologer_id );
				$records[ 'rows' ][]	=	$v;
			}
