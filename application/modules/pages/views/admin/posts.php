...
var tableConfig = {
    "columns": [{
		...
		},
		{
			...
			return  [
				...
				'<div class="attachment-block clearfix">',
						'<img class="attachment-img" src="'+base+'assets/uploads/post/resized/'+post_image+'" alt="Article Image">',
						'<div class="attachment-pushed">',
						  '<h4 class="attachment-heading"><a href="">'+row.image_title+'</a></h4>',
		...
		},
		{
			...
			return  [
				'<span>'+row.image_no_of_views+'</span>'
		...
		},
		{
			...
			return  [
				'<span>'+row.image_no_of_likes+'</span>'
		...
		},
		{
			...
			align : 'center',
			formatter : function(value , row){
				console.log('row.image_status',row)
				var xEditableOptions	=	{
						value : row.image_status,
						defaultValue : "Not active",
						type : "select",
						pk: row.image_id,
						name : 'image_status',
						url: "<?=$this->base?>pages/admin_posts/change_status",
						title: "Change Status",
    ...
    "url": base + "pages/admin_posts/list_json",
    "pagination": true,
    "pageNumber": 1,
    "pageSize": 10,
