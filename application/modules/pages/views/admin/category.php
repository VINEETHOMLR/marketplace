...
<form class="" method="post" action="<?=$this->base?>pages/admin_category/update">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <input type="hidden" name="id" value="{{record.image_category_id}}">
      ...
      <div class="row form-group">
        ...
        <div class="col-md-8">
          <input type="text" name="image_category_title"  value="{{record.image_category_title}}" class="form-control"  placeholder="Enter  category title" required >
        </div>
      </div>
...
var tableConfig = {
    "columns": [{
		...
		},
		{
			...
			return  [
				...
				'<div class="attachment-block clearfix">',
						'<img class="attachment-img" src="'+base+'assets/uploads/category/'+category_img+'" alt="Article Image">',
						'<div class="attachment-pushed">',
						  '<h4 class="attachment-heading"><a href="">'+row.image_category_title+'</a></h4>',
		...
		{
			field: 'image_category_status',
			title: 'Status',
			align : 'center',
			formatter : function(value , row){
				console.log('row.image_category_status',row)
				var xEditableOptions	=	{
						value : row.image_category_status,
						defaultValue : "Not active",
						type : "select",
						pk: row.image_category_id,
						name : 'image_category_status',
						url: "<?=$this->base?>pages/admin_category/change_status",
						title: "Change Status",
    ...
    "uniqueId" : "image_category_id",
    "classes": "table table-hover",
    "method": "POST",
    "contentType" : "application/x-www-form-urlencoded",
    "url": base + "pages/admin_category/list_json",
    "pagination": true,
    "pageNumber": 1,
    "pageSize": 10,
...
var actions = {
	delete : {
		url : base + "pages/admin_category/delete/",
	},
	add : {
		selector : '#add_new',
