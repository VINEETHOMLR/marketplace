<?php
class Admin_posts extends MX_Controller
{
    ...
    public function __construct()
    {
		...
		$this->load->model( array( 'Admin_posts_model' ) );
    }
	...
	public function list_json()
	{
		...
		$records[ 'rows' ]	=	$this->Admin_posts_model->get_list(  $image_status ,  $limit ,  $offset  ,  $date_from ,  $date_to ,  $search  );
		$records[ 'total' ]	=	$this->Admin_posts_model->get_count(  $image_status ,  $date_from ,  $date_to  ,  $search   );
	...
	public function change_status( )
	{
		...
		if( $this->Admin_posts_model->update( $data , $where ) )
		{
			$msg['res']		=	1;
	...
	{
		$image	=	$this->Admin_posts_model->get( $id );
		...
		return $this->Admin_posts_model->delete( $id );
	}
