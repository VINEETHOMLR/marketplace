<?php
class Admin_downloads extends MX_Controller
{
    ...
    public function __construct()
    {
		...
		$this->load->model( array( 'Admin_downloads_model' ) );
    }
	...
	public function list_json()
	{
		...
		$records[ 'rows' ]	=	$this->Admin_downloads_model->get_list(   $limit ,  $offset  ,  $date_from ,  $date_to ,  $search  );
		$records[ 'total' ]	=	$this->Admin_downloads_model->get_count(  $date_from ,  $date_to  ,  $search   );
	...
	{
		$data[ 'content' ] = 'admin/download/table';
	...
	public function change_status( )
	{
		...
		if( $this->Admin_downloads_model->update( $data , $where ) )
		{
			$msg['res']		=	1;
	...
	{
		$image	=	$this->Admin_downloads_model->get( $id );
		...
		return $this->Admin_downloads_model->delete( $id );
	}
