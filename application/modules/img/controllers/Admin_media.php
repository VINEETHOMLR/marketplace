<?php
class Admin_media extends MX_Controller
{
	...
	{
		Modules::run( 'img/clear' , $gallery_id ,  imageType::MEDIA  );
	...
	public function update()
	{
		...
		Modules::run( 'img/update' , 0 ,  imageType::MEDIA  );

		Modules::run('video/admin_video/update' , videoType::MEDIA , 0 , $this->input->post('videos'));
		$msg['res']		=	1;
