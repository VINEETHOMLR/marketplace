<div class="box">
  <div class="box-header with-border">
    <h3 class="box-title">Cinema</h3>
    <a href="#" id="add_new" class="btn btn-xs btn-primary pull-right"   >Add New Cinema</a>
  </div>
  <div class="box-body">
...
var tableConfig = {
		...
		
		{
			...
			formatter : function(value , row){
				var xEditableOptions	=	{
						value : row.cinema_status,
						defaultValue : "Not active",
						type : "select",
						pk: row.cinema_id,
						name : 'cinema_status',
						url: "<?=$this->base?>leftmenu/admin_cinema/change_status",
						title: "Change Status",
    ...
    "url": base + "leftmenu/cinemas/list_json",
    "pagination": true,
    "pageNumber": 1,
    "pageSize": 10,
...
var actions = {
	delete : {
		url : base + "leftmenu/admin_cinema/remove/",
	},
	add : {
		selector : '#add_new',
		...
		url : base + "leftmenu/admin_cinema/form/",
