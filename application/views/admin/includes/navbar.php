...
<nav class="navbar navbar-static-top"> 
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?=$base?>assets/img/users/<?=$this->user[ 'image' ]?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?=$this->user[ 'name' ].' '.$this->user[ 'name_last' ]?></span> </a>
          <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header"> <img src="<?=$base?>assets/img/users/<?=$this->user[ 'image' ]?>" class="img-circle" alt="User Image">
              <p> <?=$this->user[ 'name' ].' '.$this->user[ 'name_last' ]?>  <small>Gravity Managing Partner</small> </p>
            </li>
            <!-- Menu Body -->
